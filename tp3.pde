...
int bx, by, ban, bal, y;
PFont titulo, texto;
PImage maxexplorar,esperarnoche,dejar,oso2,oso,rio,explorar,volver,fondonegro1,fondonegro2,presentacion, comienzo,falla,sirenas,mensaje,altar,izquierda,entrarnave, derecha, creditos;
void setup() {
  size(600, 660);
...
void draw() {
  ...
  if (estado.equals("comienzo")) {//comeinzo..........................
    ...
    rect(bx*5, height-by/6, ban, bal);//botón de "a la derecha"    (codigo derecha abajo)
    ...
    text("Irse con el equipo", bx*5, height-bal+5);//CAMINO 2
    ///////opcion de maus
    } 
    ...
    rect(bx*5, height-by/2, ban, bal);//botón de "a la derecha"
    fill(0, 100);
    ...
    text("Ir al Bosque", bx*5, height-bal*2.8);//CAMINO 2 
 ...
 fill(255);
    ...
    text("Salir a explorar", bx*5, height-bal+5);//CAMINO 2
    ///////opcion de maus
    } 
    //oso
  ...
  //bosqauqe
 else if (estado.equals("derecha")) {//derecho.................................
...
//seguir el rio
    ...
    text("Irse a explorar mas", bx*5, height-bal+5);//CAMINO 2
    ///////opcion de maus
    } 
    //final perdido
...
void keyPressed() {
 ...
 //ir al bosque
 if (key== 'v'&&estado=="derecha") {//cuando presiono la v
    estado="fondonegro1";//
 }
 //ataque de oso
...
void mousePressed() {
  ...
  if (mouseX>400&&mouseX<600&&mouseY>485&&mouseY<534&&estado=="altar") {
    estado="derecha";
...
//despertar oso
   ...
   //irse con el equipoo
  if (mouseX>400&&mouseX<600&&mouseY>585&&mouseY<634&&estado=="mensaje") {
    estado="explorar";
   
  }
  //salir a explorar
  if (mouseX>400&&mouseX<600&&mouseY>585&&mouseY<634&&estado=="fondonegro2") {
    estado="oso2";
  }
  ...
  if (mouseX>0&&mouseX<200&&mouseY>585&&mouseY<634&&estado=="dejar") {
    ...
    if (mouseX>400&&mouseX<600&&mouseY>585&&mouseY<634&&estado=="dejar") {
    estado="maxexplorar";
    }
    }
